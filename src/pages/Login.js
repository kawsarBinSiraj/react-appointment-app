...
const Login = () => {
    ...
    return (
        <>
            <div style={{ inset: "0" }} className="login position-fixed top-0 start-0 w-100 d-flex justify-content-center bg-white">
                <form onSubmit={handleSubmit(onSubmit)} className="form-signIn m-auto w-100 pt-5" style={{ maxWidth: "300px" }}>
                    ...
                    <div className="form-floating mb-1">
                        ...
                        <label className="ps-4" htmlFor="floatingInput">
                            User name
                        </label>
                    ...
                    <div className="form-floating mb-4">
                        ...
                        <label className="ps-4" htmlFor="floatingPassword">
                            Password
                        </label>
                        <p className="text-danger mb-0">{errors.password?.message}</p>
                    </div>
                    <div className="form-group">
                        <button type="submit" className="btn btn-lg text-light w-100 bg-primary rounded-pill">
                            Log in
                        </button>
                    </div>
                </form>
